...
class General {
	...
	public function __construct(
		...
		#[ForceList]
		#[MapFrom('super_admins')]
		public array $superAdmins,
		#[CastToType('bool')]
		public bool $showAomlMarkup=false,
		#[CastToType('int')]
		public int $defaultModuleStatus=1,
		#[CastToType('bool')]
		public bool $enableConsoleClient=true,
		#[CastToType('bool')]
		public bool $enablePackageModule=true,
		#[CastToType('bool')]
		#[MapFrom('auto_org_name')]
