...
class CreateItemDBs implements SchemaMigration {
	public function migrate(LoggerInterface $logger, DB $db): void {
		...
		$db->schema()->create('aodb', static function (Blueprint $table): void {
		...
		$db->schema()->create('item_groups', static function (Blueprint $table): void {
		...
		$db->schema()->create('item_group_names', static function (Blueprint $table): void {
