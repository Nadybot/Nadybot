...
('Temple of the Three Winds', 'Armor', 1, 'Corrupted Bloodmark', '', 1, NULL),
('Temple of the Three Winds', 'Armor', 1, 'Corrupted Soulmark', '', 1, NULL),
...
('Temple of the Three Winds', 'Armor', 1, 'Twilight Entreatment Armor (Body)', '', 1, NULL),
('Temple of the Three Winds', 'Armor', 1, 'Twilight Entreatment Armor (Boots)', '', 1, NULL),
('Temple of the Three Winds', 'Armor', 1, 'Twilight Entreatment Armor (Gloves)', '', 1, NULL),
('Temple of the Three Winds', 'Armor', 1, 'Twilight Entreatment Armor (Helmet)', '', 1, NULL),
('Temple of the Three Winds', 'Armor', 1, 'Twilight Entreatment Armor (Pants)', '', 1, NULL),
('Temple of the Three Winds', 'Armor', 1, 'Twilight Entreatment Armor (Sleeves)', '', 1, NULL),
...
-- Subway 201+
INSERT INTO raid_loot (raid, category, ql, name, comment, multiloot, aoid) VALUES
('Subway', 'Armor', 1, 'Boots of Gridspace Distortion', 'Vergil', 1, null),
('Subway', 'Armor', 1, 'Condemned Bulwark', 'Abmouth', 1, null),
('Subway', 'Armor', 1, 'Counterfeit fr00b T-shirt', '', 1, null),
('Subway', 'Armor', 1, 'Eumenides''s Omni-Pol Forest Body Armor', 'Eumenides/Abmouth', 1, null),
('Subway', 'Armor', 1, 'Fetid Vagabond Cloak', '', 1, null),
('Subway', 'Armor', 250, 'Fortified Construction Sleeves', '', 1, null),
('Subway', 'Armor', 1, 'Mark of the Bloodless', 'Primal Bloodcreeper', 1, null),
('Subway', 'Armor', 1, 'Notum-Infused Wool Balaclava Mask', 'Shiro', 1, null),
...
('Subway', 'Armor', 220, 'Supreme Office Worker Suit', 'Eumenides', 1, null),
('Subway', 'Armor', 200, 'Survivalist Leather Armor Legwear', 'Queen of the Slums', 1, null),
('Subway', 'Armor', 200, 'Symbiotic Nanite Gloves', 'The Psion', 1, null),
('Subway', 'Armor', 1, 'Vergil''s Black Trenchcoat', '', 1, null),
('Subway', 'Belt', 1, 'Belt of Great Justice', 'Abmouth', 1, null),
('Subway', 'Rings', 250, 'Jester''s Gift', 'Abmouth', 1, null),
('Subway', 'Rings', 250, 'Superior Ring of the Nucleus Basalis', 'Eumenides', 1, null),
('Subway', 'HUD/Utils', 100, 'Amalgamated Research Attunement Device', 'Queen of the Slums', 1, null),
('Subway', 'HUD/Utils', 250, 'Aspect of Paralyzing Fear', '', 1, null),
('Subway', 'HUD/Utils', 210, 'Combat Assist Wen-Wen', 'Shiro', 1, null),
('Subway', 'HUD/Utils', 250, 'Eye of The Psion', 'The Psion/Abmouth', 1, null),
('Subway', 'HUD/Utils', 100, 'Patchwork Defensive Drone', 'Abmouth', 1, null),
('Subway', 'HUD/Utils', 250, 'Technical Guidance Personal Terminal', 'Eumenides', 1, null),
('Subway', 'HUD/Utils', 1, 'Unstable Damage Augmentation Device', 'Shiro', 1, null),
('Subway', 'Weapons', 200, 'BBI Faithful 1000', 'Eumenides/Abmouth', 1, null),
('Subway', 'Weapons', 300, 'Distraction Rifle', 'Shiro', 1, null),
('Subway', 'Weapons', 1, 'Illegally Augmented Ofab Mongoose', 'Queen of the Slums', 1, null),
('Subway', 'Weapons', 300, 'Illegally-Modified Dreadloch Tigress', 'The Psion', 1, null),
('Subway', 'Weapons', 300, 'Illegally Modified Dreadloch Panther', 'The Psion/Abmouth', 1, null),
('Subway', 'Weapons', 300, 'Illegally Modified Dreadloch Thrasher', 'Vergil', 1, null),
('Subway', 'Weapons', 300, 'Illegally Modified Dreadloch Remodulator', 'Vergil', 1, null),
('Subway', 'Weapons', 300, 'Illegally Modified Dreadloch Modified Shark', 'Abmouth', 1, null),
('Subway', 'Weapons', 300, 'Illegally Modified Dreadloch Obliterator', 'Abmouth', 1, null),
('Subway', 'Weapons', 200, 'Lost Blade of Elder Tsunayoshi', 'Vergil', 1, null),
('Subway', 'Weapons', 300, 'Vicious Support Beam of Malice', 'Abmouth', 1, null);
