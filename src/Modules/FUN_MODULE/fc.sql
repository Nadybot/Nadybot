...
('fc', 'I can assure you that any actions taken by the GMs were appropriate. --Craig "Silirrion" Morrison'),
...
('fc', 'god, Argure, honestly.  If you''re so confident you can manage the business, please apply for a damned job. --Anarrina'),
...
('fc', 'The account is unfortunately not eligible to be reopened. I''m sorry for any difficulty this may cause. If you''d like, you''re free to create a new account if you would like to return to the game. --GM discussing a closed account'),
('fc', 'We do not discriminate or show favoritism towards any players, we are neutral regarding all issues. --GM Raetos');
