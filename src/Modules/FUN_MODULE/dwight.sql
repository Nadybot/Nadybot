...
('dwight', 'My feelings regenerate at twice the speed of a normal man.'),
('dwight', 'Before I do anything I ask myself "Would an idiot do that?" And if the answer is yes, I do not do that thing.'),
('dwight', 'Dolphins get a lot of good publicity for the drowning swimmers they push back to shore, but what you don''t hear about is the many people they push farther out to sea.'),
('dwight', 'There are 3 things you never turn your back on: bears, men you have wronged and dominant male turkey during mating season.'),
...
('dwight', 'With the electricity we are using to keep Meredith alive we could power a small fan for two days. You tell me what''s unethical.'),
('dwight', 'In the wild, there is no healthcare. Healthcare is "Oh, I broke my leg!" A lion comes and eats you, your dead.'),
('dwight', 'In an ideal world I would have all ten fingers on my left hand and the right one would just be left for punching.'),
...
('dwight', 'Women are like wolves. If you want one you must trap it. Snare it. Tame it. Feed it.'),
...
('dwight', '[About the tux he''s wearing] It belonged to my grandfather. He was buried in it, so... family heirloom.'),
...
('dwight', 'My grandfather left me a 60-acre working beet farm. I run it with my cousin Mose. We sell beets to the local stores and restaurants. It''s a nice little farm... Sometimes teenagers use it for sex.'),
('dwight', 'I live in a 9-bedroom farmhouse. I have my own crossbow range. It''s the perfect situation for me. Although the two bathrooms would have been nice. We just have the one... and it''s under the porch.'),
